...
class PageIndexRow(BaseModel):
    ...
    PageIndex is a vectorless / reasoning-based retriever that returns a list
    of evidence snippets per query. The field 'question' is accepted as an
    alias for 'query' to match the input file format.
    """
...
class BGEM3Row(BaseModel):
    ...
    query: str
    ground_truth: str
    retriever: Literal["bge_m3", "hybrid_qdrr"] = "bge_m3"
